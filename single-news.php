          ...
          <div class="single-article-section">
            <div class="single-article-text">
              ...
              <p>
                ...
                temporibus laudantium quidem recusandae expedita dicta cum
                eum. Quae laborum repellat a ut, voluptatum ipsa eum. Culpa
                fugiat minus laborum quia nam!
              </p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et,
                praesentium, dicta. Dolorum inventore molestias velit
                possimus, dolore labore aliquam aperiam architecto quo
                reprehenderit excepturi ipsum ipsam accusantium nobis ducimus
                laudantium.
              </p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Rerum est aperiam voluptatum id cupiditate quae corporis ex.
                Molestias modi mollitia neque magni voluptatum, omnis
                repudiandae aliquam quae veniam error! Eligendi distinctio, ab
                eius iure atque ducimus id deleniti, vel alias sint similique
                perspiciatis saepe necessitatibus non eveniet, quo nisi
                soluta.
              </p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              ...
              <div class="comment-list">
                <div class="single-comment-body">
                  ...
                  <div class="comment-text-body">
                    <h4>
                      Jenny Joe
                      <span class="comment-date">Aprl 26, 2020</span>
                      <a href="#">reply</a>
                    </h4>
                    <p>
                  ...
                  <div class="single-comment-body child">
                    ...
                    <div class="comment-text-body">
                      <h4>
                        Simon Soe
                        <span class="comment-date">Aprl 27, 2020</span>
                        <a href="#">reply</a>
                      </h4>
                      <p>
                        Nunc risus ex, tempus quis purus ac, tempor consequat
                ...
                <div class="single-comment-body">
                  ...
                  <div class="comment-text-body">
                    <h4>
                      Addy Aoe <span class="comment-date">May 12, 2020</span>
                      <a href="#">reply</a>
                    </h4>
                    <p>
                      Nunc risus ex, tempus quis purus ac, tempor consequat
        ...
        <div class="col-lg-4">
          <div class="sidebar-section">
            <div class="recent-posts">
              ...
              <ul>
                <li>
                  <a href="single-news.php">You will vainly look for fruit on it in autumn.</a>
                </li>
                <li>
                  <a href="single-news.php">A man's worth has its season, like tomato.</a>
                </li>
                <li>
                  <a href="single-news.php">Good thoughts bear good fresh juicy fruit.</a>
                </li>
                <li>
                  <a href="single-news.php">Fall in love with the fresh orange</a>
                </li>
                <li>
                  <a href="single-news.php">Why the berries always look delecious</a>
                </li>
              </ul>
            </div>
